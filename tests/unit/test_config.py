...
class TestS3Config:
    ...
    def test_s3_config_from_dict_missing_fields(self):
        ...
        data = {"access_key_id": "test_key", "region": "us-east-1"}
...
class TestStorachaConfig:
    ...
    def test_storacha_config_missing_endpoint_url(self):
        ...
        with pytest.raises(ValueError, match="endpoint_url is required"):
            StorachaConfig(api_key="test_key", endpoint_url="", space_name="my-space")
...
"""
    ...
    def test_create_configs_from_dict(self):
        ...
        data = {
            ...
            "migration": {"batch_size": 250, "timeout_seconds": 450},
        }

        s3_config, storacha_config, migration_config = (
            ConfigurationParser.create_configs_from_dict(data)
        )
    ...
    def test_create_configs_from_file(self):
        ...
        config_data = {
            ...
            "migration": {"batch_size": 75, "verbose": True},
        }
        ...
        try:
            s3_config, storacha_config, migration_config = (
                ConfigurationParser.create_configs_from_file(temp_path)
            )
