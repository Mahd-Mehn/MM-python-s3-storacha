...
from py_s3_storacha import S3Config, StorachaConfig, MigrationConfig, S3ToStorachaMigrator, MigrationRequest
...
def migrate_to_storacha(
    ...
    print(f"💾 Total size: {result.total_size_bytes:,} bytes ({result.total_size_bytes / (1024**2):.2f} MB)")
