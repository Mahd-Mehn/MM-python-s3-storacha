...
class ConfigurationParser:
    ...
    @staticmethod
    def create_configs_from_dict(data: Dict[str, Any]) -> tuple[S3Config, StorachaConfig, MigrationConfig]:
    ...
    @staticmethod
    def create_configs_from_file(file_path: Union[str, Path]) -> tuple[S3Config, StorachaConfig, MigrationConfig]:
